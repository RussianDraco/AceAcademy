...
flashbutton = Button(600, 500, 100, 30, "Flashcards", flashcardsection.open_flashcard_section, overrideColour = BACKGROUND)
...
navbarbuttons = [homebutton, studytimerbutton, settingsbutton]
